...
let spillersValg = await velgeUtfall(VALG_MULIGHETER);

// -------- AI velger ---------------

let npcValg = aiVelgerUtfall(VALG_MULIGHETER);
...
if(npcValg === spillersValg){
  ...
  // { s: "x", p: "r", x: "p" }
  spillersValg = "s"
  let hvaJegVinnerIMot = VALG_MULIGHETER[spillersValg]
  ...
  /* let vantSpilleren = false;
  
  if(spillersValg === "s"){
    if(npcValg === "x"){
      vantSpilleren = true;
    }
  } else if(spillersValg === "p"){
    if(npcValg === "r"){
      vantSpilleren = true;
    }
  }else if(spillersValg === "x"){
    if(npcValg === "p"){
      vantSpilleren = true;
    }
  } */
