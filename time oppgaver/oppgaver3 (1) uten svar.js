...
const DICTIONARY_ML = {
    no:{
        hello:"Hei på deg",
        howAreYou:"hvordan står det til?",
        goodQuestionsLatly:"Fått noen bra spørsmål i det siste?",
    },
    en:{
        hei:"Hey there",
        hvordanHarDu:"how are you doing?",
        braSporsmaal:"Gotten any good questions lately?"
...
if(language === en){
console.log(`${DICTIONARY.en.hei} Christian ${DICTIONARY.en.hvordanHarDu}`);
console.log(`${DICTIONARY.en.braSporsmaal}`);
} else{
    console.log(`${DICTIONARY.no.hello} Christian ${DICTIONARY.no.howAreYou}`);
    console.log(`${DICTIONARY.no.goodQuestionsLatly}`);
}
